class Pairstair < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/gypsydave5/pairstair/releases/download/v0.3.14/pairstair-darwin-arm64"
      sha256 "77eab63c73f74c0688b2122336cc7437d13a11a90507f54cd5cbae748de227a9"
    end

    on_intel do
      url "https://github.com/gypsydave5/pairstair/releases/download/v0.3.14/pairstair-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/gypsydave5/pairstair/releases/download/v0.3.14/pairstair-linux-arm64"
      sha256 "8a958faad77f49e2c7d565ff351bb89eaf3fa5c9fccbd7b27039b52e5bbd2485"
    end

    on_intel do
      url "https://github.com/gypsydave5/pairstair/releases/download/v0.3.14/pairstair-linux-amd64"
      sha256 "d3e36b85f4978e9dcec42fa75c2b646741046300b8534b7e8fb3d6ba582d9621"
    end
  end

  resource "man" do
    url "https://github.com/gypsydave5/pairstair/releases/download/v0.3.14/pairstair.1"
